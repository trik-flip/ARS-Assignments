...
ax.plot_surface(x, y, z, cmap='ocean',antialiased=True,edgecolor='none',alpha=0.6)
ax.set_xlabel('x')
ax.set_ylabel('y')
ax.set_zlabel('z');
# plt.show()
...
scatter = ax.scatter(
    ...
    c=(10,20,1,2,21,3,13,21,321,213,21,321,31,32,132,13,21,321,32,1),
    linewidths=1,
    label="scatter",
)
epoch = 1
while veloc.max() > 1e-2:
